...
socket.on('app_signing', function (data) {
    //console.log(data.fields)
    app_signing = data
  
   for (var i = 0; i < data.fields.length; i++) {
      var allJsonHolder = document.getElementById('appSigning')
  ...
  var repos = document.getElementById('repositories')
    ...
    function myfunction2 () {
      ...
      socket.on('pathTo_app_signing' , function (pathTo_app_signing) {
        console.log(pathTo_app_signing)  
        for (var i = 0; i < app_signing.fields.length; i++) {
          var jKEY = app_signing.fields[i].jsonKeyPath
          var subPath = app_signing.fields[i].subPath
          var tmp = document.getElementById(jKEY)
          console.log(app_signing.fields[i])
          if (app_signing.fields[i].type === 'boolean') {
            console.log(app_signing.fields[i])
          }
          if (subPath === false){
            tmp.value =  pathTo_app_signing[jKEY]
          }
          ...
          if (subPath === true) {
            ...
            switch (tLength) {
                      case 1:
                        var t0 = temp[0]
                        tmp.value = pathTo_app_signing[t0]
                        break
                      case 2:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        tmp.value = pathTo_app_signing[t0][t1]
                        break
                      case 3:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        var t2 = temp[2]
                        tmp.value = pathTo_app_signing[t0][t1][t2]
                        break
                      case 4:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        var t2 = temp[2]
                        var t3 = temp[3]
                        tmp.value = pathTo_app_signing[t0][t1][t2][t3]
                        break
                      case 5:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        ...
                        var t3 = temp[3]
                        var t4 = temp[4]
                        tmp.value = pathTo_app_signing[t0][t1][t2][t3][t4]
                        break
                      case 6:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        ...
                        var t4 = temp[4]
                        var t5 = temp[5]
                        tmp.value = pathTo_app_signing[t0][t1][t2][t3][t4][t5]
                        break
                      case 7:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        ...
                        var t5 = temp[5]
                        var t6 = temp[6]
                        tmp.value = pathTo_app_signing[t0][t1][t2][t3][t4][t5][t6]
                    }
