socket.on('epaper3', function (data) {
    //console.log(data.fields)
    epaper3 = data
  
   for (var i = 0; i < data.fields.length; i++) {
      var allJsonHolder = document.getElementById('epaperThree')
  ...
  var repos = document.getElementById('repositories')
    ...
    function myfunction2 () {
      ...
      socket.on('pathTo_epaper3' , function (pathTo_epaper3) {
        
        for (var i = 0; i < epaper3.fields.length; i++) {
          var jKEY = epaper3.fields[i].jsonKeyPath
          var subPath = epaper3.fields[i].subPath
          var tmp = document.getElementById(jKEY)
  
          if (epaper3.fields[i].type === 'boolean') {
            console.log(epaper3.fields[i])
          }
          ...
          if (subPath === true) {
            ...
            switch (tLength) {
                      case 1:
                        var t0 = temp[0]
                        tmp.value = pathTo_epaper3[t0]
                        break
                      case 2:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        tmp.value = pathTo_epaper3[t0][t1]
                        break
                      case 3:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        var t2 = temp[2]
                        tmp.value = pathTo_epaper3[t0][t1][t2]
                        break
                      case 4:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        var t2 = temp[2]
                        var t3 = temp[3]
                        tmp.value = pathTo_epaper3[t0][t1][t2][t3]
                        break
                      case 5:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        ...
                        var t3 = temp[3]
                        var t4 = temp[4]
                        tmp.value = pathTo_epaper3[t0][t1][t2][t3][t4]
                        break
                      case 6:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        ...
                        var t4 = temp[4]
                        var t5 = temp[5]
                        tmp.value = pathTo_epaper3[t0][t1][t2][t3][t4][t5]
                        break
                      case 7:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        ...
                        var t5 = temp[5]
                        var t6 = temp[6]
                        tmp.value = pathTo_epaper3[t0][t1][t2][t3][t4][t5][t6]
                    }
           // console.log(`currentConfigs.${jKEY} = ${currentConfigs[t0][t1]}`)
          }else {
            tmp.value = pathTo_epaper3[jKEY]
          }
        }
      })
