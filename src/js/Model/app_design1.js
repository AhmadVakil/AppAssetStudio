...
socket.on('app_Design1', function (data) {
    //console.log(data.fields)
    app_Design1 = data
  
   for (var i = 0; i < data.fields.length; i++) {
      var allJsonHolder = document.getElementById('AppDesignOne')
  ...
  var repos = document.getElementById('repositories')
    ...
    function myfunction2 () {
      ...
      socket.on('pathTo_app_design1' , function (pathTo_app_Design1) {
        console.log(pathTo_app_Design1)
        for (var i = 0; i < app_Design1.fields.length; i++) {
          var jKEY = app_Design1.fields[i].jsonKeyPath
          var subPath = app_Design1.fields[i].subPath
          var tmp = document.getElementById(jKEY)
          console.log(app_Design1.fields[i])
          if (app_Design1.fields[i].type === 'boolean') {
            console.log(app_Design1.fields[i])
          }
          if (subPath === false){
            tmp.value =  pathTo_app_Design1[jKEY]
          }
          ...
          if (subPath === true) {
            ...
            switch (tLength) {
                      case 1:
                        var t0 = temp[0]
                        tmp.value = pathTo_app_Design1[t0]
                        break
                      case 2:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        tmp.value = pathTo_app_Design1[t0][t1]
                        break
                      case 3:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        var t2 = temp[2]
                        tmp.value = pathTo_app_Design1[t0][t1][t2]
                        break
                      case 4:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        var t2 = temp[2]
                        var t3 = temp[3]
                        tmp.value = pathTo_app_Design1[t0][t1][t2][t3]
                        break
                      case 5:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        ...
                        var t3 = temp[3]
                        var t4 = temp[4]
                        tmp.value = pathTo_app_Design1[t0][t1][t2][t3][t4]
                        break
                      case 6:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        ...
                        var t4 = temp[4]
                        var t5 = temp[5]
                        tmp.value = pathTo_app_Design1[t0][t1][t2][t3][t4][t5]
                        break
                      case 7:
                        var t0 = temp[0]
                        var t1 = temp[1]
                        ...
                        var t5 = temp[5]
                        var t6 = temp[6]
                        tmp.value = pathTo_app_Design1[t0][t1][t2][t3][t4][t5][t6]
                    }
