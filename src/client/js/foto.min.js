class Foto {
    disableButtons(){
        ...
        document.getElementById("tool-box").className = "operation-btn-disabled",
    ...
    loadImage() {
        ...
        e.onload = function(t) {
            ...
            a.image.onload = function() {
                ...
                document.getElementById("blinker").style.animation= "blinker 2s linear infinite",
                */
                document.getElementById("tool-box").disabled = false,
                ...
                document.getElementById("colorize-color-picker").disabled = false,
                document.getElementById("makeTransparent").disabled = false,
                document.getElementById("tool-box").className = "operation-btn",
